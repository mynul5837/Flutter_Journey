...
class CardListScreen extends StatelessWidget {
  ...
  final List<Item> items = const [
    Item(
      ...
      description:
          'Experience the breathtaking views of mountain ranges with our guided tours. Perfect for nature lovers and adventure seekers.',
    ),
    Item(
      ...
      description:
          'Relax on pristine beaches with crystal-clear waters. Enjoy water sports, sunset cruises, and beachside dining.',
    ),
    Item(
      ...
      description:
          'Discover the vibrant city life with our comprehensive city tours. Visit historical landmarks and modern attractions.',
    ),
  ];
